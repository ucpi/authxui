    ...
    <>
      <Element id="section-4" className="section-4" name="section-4">
        ...
        <div className="container">
          ...
          <p className="step-3">
            3. Each Authentication node seperately verifies the JWT token with
            the centralised issuer via its APIs and pushes the signed
            verification data and it's vote on AuthX smart Contract.
          </p>
          <p className="step-4">
